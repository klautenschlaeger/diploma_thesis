...
According to \textcite{Dorathy} network simulation can analyze the performance of network applications and routing protocols in various scenarios.
\textcite{kumar} argue that network simulation is a cost-effective and flexible method to evaluate the performance of a network protocol.
...
Various tools are already available, such as Matlab, ns-2 and ns-3, OMNeT++, Qualnet \cite{keller_simulation_2021} or OPNet \cite{kumar_simulators_2012}.
