...
\todo[color=yellow]{UI for selecting the TM to display? Black and White?}
...
A \ac{TM} is in a platoon with a \ac{FH} if the distance to the \ac{FH} is less \SI{10}{\metre} and they are moving at nearly the same speed with a maxmimum
...
The final weights are \nicefrac{3}{5} and \nicefrac{2}{5} for the distance and speed difference, respectively.


\todo[color=yellow]{Add stacked plot, map problem again}
\begin{comment}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.5\textwidth}
 	\centering
	\includegraphics[width=\figsize\columnwidth]{figures/ScreenshotToResultsPNG}
	\caption{Caption under subfigure.}
	\label{fig:figsublabel_01}
	\end{subfigure}%
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
 		\includegraphics[width=\figsize\columnwidth]{figures/resultCornData}
 		\caption{Caption under subfigure.}
...
\begin{figure}%
    \centering
    \subfloat[coverage]{\label{fig:setup1}\includegraphics[width=0.8\textwidth]{figures/ScreenshotToResultsPNG}}%
	\\
    \subfloat[connectivity]{\label{fig:setup2}\includegraphics[width=0.9\textwidth]{figures/resultCornData}}
