...
\begin{figure}%
    \centering
    \subfloat[Travel lane]{\label{fig:setup1}\includegraphics[width=0.8\textwidth]{figures/ScreenshotToResultsPNG2}}%
   \\
...
\todo[color=yellow]{Berechnung aufschreiben... }
...
\TODO{Einordnen in andere Scenarios}
