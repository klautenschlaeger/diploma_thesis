...
To get a first glance of the recorded data, I built a dashboard with the Python framework \textit{Dash}\footnote{https://dash.plotly.com/introduction}.
...
I determined the weights by Trial-and-Error \todo[color=blue]{Passt das?} method, where I set the weights and displayed
...
To make a general statement, I should use data from different years, machines and harvest and loading scenarios,
because they can reveal different initial field conditions.
