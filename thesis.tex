...
In the next chapter, I would like to examine the influence of the different physical layer parameters on the goodput, robustness and latency.
Since, as described, the existing technology cannot be controlled explicitly, the influence of parameters is analysed by a simulation study.
...
\textcite{omar_survey_2016} adds that simulation is the main evaluation method for IEEE 802.11ax networks, which the IEEE 802.11ax task group considers.
