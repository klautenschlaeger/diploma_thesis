...
implements \cite{Iglesias2014GUIsISOBUS}. According to \textcite{schlingmann2019AEFusecases}, the ISO 11783 standard is known as
the ISOBUS system.
...
that can realize the required data rates, latencies and high transmission range. The plans for doing so are written down by members of the \ac{WIC} project group in \cite{Schlingmann2017AEF11p}.
