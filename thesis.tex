...
If two or more stations communicate directly without an AP, they form an ad hoc network.
...
To enable communication between Wi-Fi devices, the IEEE 802.11 standard defines the following layers of the OSI model. The first layer is the physical layer.
