...
\DeclareAcronym{PD}{
	short=PD,
	long=Plant Density,
	long-plural-form=Plant Densities,
}
\DeclareAcronym{WIC}{
	short=WIC,
...
\DeclareSIUnit{\belisotopic}{Bi}
\DeclareSIUnit{\dBi}{\deci\belisotopic}
...
\input{Latex/sub_tex_files/abstract}
...
\input{Latex/sub_tex_files/introduction}
...
\input{Latex/sub_tex_files/wic}

\input{Latex/sub_tex_files/cornHarvest}
...
\input{Latex/sub_tex_files/wiFiphy}

\input{Latex/sub_tex_files/wifiMac}
...
\input{Latex/sub_tex_files/simulation}

\section{Related Work}
\input{Latex/sub_tex_files/relatedWorkWIC}


\input{Latex/sub_tex_files/cornHarvestData}

\chapter{Field Measurements}


\input{Latex/sub_tex_files/fieldexperiment}
...
\input{Latex/sub_tex_files/robustness}

\input{Latex/sub_tex_files/dataRate}
...
\input{Latex/sub_tex_files/platooning}
\begin{comment}
	\chapter{Evaluation}
...
\input{Latex/sub_tex_files/conclusion}
