...
When passing houses, industrial, or farm buildings, additional Wi-Fi transmissions can be expected. The results showed that some channel capacity is still left for further data exchange. \todo{Add more information about the impact of interference.}
