...
which is the desired $platoon\_data\_interval$. The mean latency is nearly the same as in \autoref{fig:mean_50}.

\autoref{fig:mean_50} indicates, that the mean update rate increases with the number of \ac{FH}s and \ac{TM}s and
