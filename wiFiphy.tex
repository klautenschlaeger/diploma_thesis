...
when 20 Mhz transmissions with either 242-Resource Unit with \ac{HE}-MCS-0 - \ac{HE}-MCS-2 or 106-Resource Unit with \ac{HE}-MCS-0 are used on a spatial stream.
