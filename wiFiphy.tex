...
This results in 13 channels in Europe in the frequency band of \SIrange{2.412}{2.482}{\giga\hertz} and 18 channels in the frequency band of \SIrange{5.180}{5.350}{\giga\hertz} and \SIrange{5.470}{5.725}{\giga\hertz} \cite{sauter_wireless_2022}.
...
\cite{noauthor_ieee_2021} provides a receiver minimum input sensitivity, which indicates until which \ac{RSS} a packet is
...
IEEE 802.11ax introduced \ac{MU}-\ac{MIMO} in the Uplink direction \cite{noauthor_ieee_2021}, where multiple \acp{STA} can transmit data simultaneously to the \ac{AP} via different available \ac{MIMO} streams.
...
Here, \textcite{stamoulis_impact_2003} has investigated the potential effect of \acp{STBC} on Wi-Fi.
...
IEEE 802.11ax stations can optionally use \ac{STBC} under the following conditions \cite{noauthor_ieee_2021}:
\begin{itemize}
