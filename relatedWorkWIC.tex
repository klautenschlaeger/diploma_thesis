\todo[color=blue]{Den Teil haben mehrere Leute Korrektur gelesen. Kannst du gut auslassen ;-)}
...
For the MAC layer with its \ac{CSMACA} mechanism, the \textcite{aust_outdoor_2015} state, that the increased propagation delay in outdoor scenarios
