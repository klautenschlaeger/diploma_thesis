...
A Constant Rate Wifi Manager is used to set a constant data rate according to the fixed HE-\ac{MCS} for data, non-uniform and control data transmissions.
...
As mentioned in ns-3 Version 3.37, the Extended Range Mode is implemented as an \ac{HE} Capability with the new extended WifiPreamble.
...
\todo[color=yellow]{nothing to cite?}
