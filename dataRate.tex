...
The function parameters are Information about the packet, channel frequency and station ID and an instance of the WifiTxVector class. According to \cite{ClassReference}, \todo[color=blue]{how to cite?} the WifiTxVector instance describes all parameters of the transmission in
