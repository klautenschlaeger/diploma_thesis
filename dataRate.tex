\section{Data Rate}
\label{sec:DataRate}
As ns-3 is an open-source simulation software and was used by other researchers too in the past, I used ns-3
...
WiFi access is based on \ac{CSMACA}, meaning the stations have to wait for a random time before transmitting on a free channel.
