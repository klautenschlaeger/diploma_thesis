...
\begin{figure}[H]%
   \centering
   \includegraphics[width=0.74\textwidth]{Latex/figures/MCS_PER_to_SNR.pdf}
...
\begin{figure}[H]%
   \centering
   \includegraphics[width=0.74\textwidth]{Latex/figures/LDPC_PER_to_SNR.pdf}
...
\begin{figure}[H]%
   \centering
   \includegraphics[width=0.74\textwidth]{Latex/figures/GI_PER_to_SNR.pdf}
...
\begin{figure}[H]%
   \centering
   \includegraphics[width=0.65\textwidth]{Latex/figures/DCM_PER_to_SNR.pdf}
...
\begin{figure}%
   \centering
   \includegraphics[width=0.74\textwidth]{Latex/figures/ER_PER_to_SNR.pdf}
...
\begin{figure}%
   \centering
   \includegraphics[width=0.74\textwidth]{Latex/figures/STBC_PER_to_SNR.pdf}
