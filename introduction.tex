...
\end{itemize}
\todo[color=yellow]{Past or Future?}
...
In my final thesis, I indend to support the progress of the \ac{WIC} project group \todo[color=yellow]{?} and investigate how modern Wi-Fi can enable \ac{WIC}. In particular, I will focus on the current Wi-Fi standard, IEEE 802.11ax.
