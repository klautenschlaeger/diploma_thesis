...
\TODO{PAUL 1800m, Pflanzen Felder Log Distance, iperf, Guard Interval}
\TODO{Brinkhoff, log distance, far over 1000m, the higher the better, higher ground reflection and not log distance anymore}